...
const HeroServices = () => {
  ...
  let props = useParams()
    ...
    return (
      ...
      <section className="section-hero pt-[100px] pb-[120px] max-w-6xl mx-auto flex justify-around px-30 ">
...
<Form/>
        ...
        <h2 className='text-[#142266] font-bold text-3xl mx-auto mb-[20px] max-w-xl'>{props.servicename},   {t('hero-ser-title')}</h2>
